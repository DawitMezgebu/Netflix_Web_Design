  ...
  return (
    <div className="bg-black">
      <Center className=" flex flex-col">
        <Text class="text-red-600">Price</Text>
        <Title class="lg:text-4xl font-bold text-white">
      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white hover:shadow-2xl">
            ...
            <a
              href="."
              class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-yellow-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-yellow-900"
            >
              Get started
            </a>
          </div>
